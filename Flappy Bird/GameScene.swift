...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makePipes() {
        ...
        var movePipes = SKAction.moveByX(-self.frame.size.width * 1.5, y: 0, duration: NSTimeInterval(self.frame.size.width / 133))
        var removePipes = SKAction.removeFromParent()
        var movaAndRemovePipes = SKAction.sequence([movePipes, removePipes])
        ...
        pipe1.runAction(movaAndRemovePipes)
        ...
        pipe2.runAction(movaAndRemovePipes)
        ...
        gap.runAction(movaAndRemovePipes)
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        if contact.bodyA.categoryBitMask == gapGroup || contact.bodyB.categoryBitMask == gapGroup {
            ...
            if gameOver == 0 {
                ...
                gameoverLabel.text = "你死了！点击重新开始游戏"
